...
6. Compare your 3-D scatterplot and the `GGally::ggpairs` output. The 3D gives a clearer visualization.
  ...
  GGpairs is easier to interpret while 3D though gives a 3dimensional angle of the plot may be difficult to interpret. The advantage is you can rotate the plot.
